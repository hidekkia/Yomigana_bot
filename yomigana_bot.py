...
data_frame = pd.read_excel('D:\hideki\yomigana_bot\Lista geral karaoke (HIDEKI).xlsx') #Carregar o arquivo Excel com os nomes dos cantores e músicas
arquivo_excel = 'D:\hideki\yomigana_bot\yomigana_bot.xlsx' # Carregar o arquivo Excel que receberás os dados coletados
